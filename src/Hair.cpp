...
Hair::Hair()
{
  ...
  m_hairNodes.push_back(HairMass({6,4,3}));
  m_hairNodes.back().m_parentHair = &m_hairNodes[2];
  ...
  HairSpring spr3 = HairSpring();
  spr3.LeftMass = &m_hairNodes[2];
  spr3.RightMass = &m_hairNodes[3];

  m_hairSprings.push_back(spr1);
  m_hairSprings.push_back(spr2);
  m_hairSprings.push_back(spr3);
  ...
  HairHinge hg2 = HairHinge();
  hg2.LeftMass = &m_hairNodes[1];
  hg2.MiddleMass = &m_hairNodes[2];
  hg2.RightMass = &m_hairNodes[3];

  m_hairHinges.push_back(hg1);
  m_hairHinges.push_back(hg2);
